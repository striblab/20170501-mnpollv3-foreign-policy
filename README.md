# Star Tribune - Minnesota Poll 2017: Foreign Policy
...
1. Get code and enter project: `git clone https://github.com/striblab/20170501-mnpollv3-foreign-policy.git && cd 20170501-mnpollv3-foreign-policy.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170501-mnpollv3-foreign-policy/ && rsync -rav ./ ../20170501-mnpollv3-foreign-policy/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
